...
// A Bgld represents a Bgld client
type Bgld struct {
	client *rpcClient
}

// New return a new bitcoind
func New(host string, port int, user, passwd string, useSSL bool, timeoutParam ...int) (*Bgld, error) {
...
func (b *Bgld) BackupWallet(destination string) error {
...
func (b *Bgld) DumpPrivKey(address string) (privKey string, err error) {
...
func (b *Bgld) GetAccountAddress(account string) (address string, err error) {
...
func (b *Bgld) GetAddressesByAccount(account string) (addresses []string, err error) {
...
func (b *Bgld) GetBalance(account string, minconf uint64) (balance float64, err error) {
...
func (b *Bgld) GetBestBlockhash() (bestBlockHash string, err error) {
...
func (b *Bgld) GetBlock(blockHash string) (block Block, err error) {
...
func (b *Bgld) GetRawBlock(blockHash string) (str string, err error) {
...
func (b *Bgld) GetBlockCount() (count uint64, err error) {
...
func (b *Bgld) GetBlockHash(index uint64) (hash string, err error) {
...
func (b *Bgld) GetBlockTemplate(capabilities []string, mode string) (template string, err error) {
...
func (b *Bgld) GetChainTips() (tips []ChainTip, err error) {
...
func (b *Bgld) GetConnectionCount() (count uint64, err error) {
...
func (b *Bgld) GetDifficulty() (difficulty float64, err error) {
...
func (b *Bgld) GetGenerate() (generate bool, err error) {
...
func (b *Bgld) GetHashesPerSec() (hashpersec float64, err error) {
...
func (b *Bgld) GetInfo() (i Info, err error) {
...
func (b *Bgld) GetMiningInfo() (miningInfo MiningInfo, err error) {
...
func (b *Bgld) GetNewAddress(account ...string) (addr string, err error) {
	// 0 or 1 account
	if len(account) > 1 {
...
func (b *Bgld) GetPeerInfo() (peerInfo []Peer, err error) {
...
func (b *Bgld) GetRawChangeAddress(account ...string) (rawAddress string, err error) {
	// 0 or 1 account
	if len(account) > 1 {
...
func (b *Bgld) GetRawMempool() (txId []string, err error) {
...
// map [TxId] => VerboseTx
func (b *Bgld) GetRawMempoolVerbose() (txs map[string]VerboseTx, err error) {
...
func (b *Bgld) GetRawTransaction(txId string, verbose bool) (rawTx interface{}, err error) {
	intVerbose := 0
	if verbose {
		intVerbose = 1
	}
...
func (b *Bgld) GetReceivedByAccount(account string, minconf uint32) (amount float64, err error) {
	if account == "all" {
		account = ""
	}
...
func (b *Bgld) GetReceivedByAddress(address string, minconf uint32) (amount float64, err error) {
...
// GetTransaction returns a Bgld.Transation struct about the given transaction
func (b *Bgld) GetTransaction(txid string) (transaction Transaction, err error) {
...
func (b *Bgld) GetTxOut(txid string, n uint32, includeMempool bool) (transactionOut UTransactionOut, err error) {
...
func (b *Bgld) GetTxOutsetInfo() (txOutSet TransactionOutSet, err error) {
...
func (b *Bgld) GetWork(data ...string) (response interface{}, err error) {
	if len(data) > 1 {
...
func (b *Bgld) ImportPrivKey(privKey, label string, rescan bool) error {
...
func (b *Bgld) KeyPoolRefill() error {
...
func (b *Bgld) ListAccounts(minconf int32) (accounts map[string]float64, err error) {
...
func (b *Bgld) ListAddressGroupings() (list []ListAddressResult, err error) {
...
func (b *Bgld) ListReceivedByAccount(minConf uint32, includeEmpty bool) (list []ReceivedByAccount, err error) {
...
// ListReceivedByAccount Returns an slice of AccountRecieved:
func (b *Bgld) ListReceivedByAddress(minConf uint32, includeEmpty bool) (list []ReceivedByAddress, err error) {
...
// ListSinceBlock
func (b *Bgld) ListSinceBlock(blockHash string, targetConfirmations uint32) (transaction []Transaction, lastBlock string, err error) {
...
func (b *Bgld) ListTransactions(account string, count, from uint32) (transaction []Transaction, err error) {
...
func (b *Bgld) ListUnspent(minconf, maxconf uint32) (transactions []Transaction, err error) {
	if maxconf > 999999 {
		maxconf = 999999
	}
...
func (b *Bgld) ListLockUnspent() (unspendableOutputs []UnspendableOutput, err error) {
...
func (b *Bgld) LockUnspent(lock bool, outputs []UnspendableOutput) (success bool, err error) {
...
func (b *Bgld) Move(formAccount, toAccount string, amount float64, minconf uint32, comment string) (success bool, err error) {
...
func (b *Bgld) SendFrom(fromAccount, toAddress string, amount float64, minconf uint32, comment, commentTo string) (txID string, err error) {
...
func (b *Bgld) SendMany(fromAccount string, amounts map[string]float64, minconf uint32, comment string) (txID string, err error) {
...
func (b *Bgld) SendManySubtractFeeFrom(fromAccount string, amounts map[string]float64, minconf uint32, comment string, feefrom []string) (txID string, err error) {
...
// https://bitcoincore.org/en/doc/0.16.0/rpc/wallet/sendmany/
func (b *Bgld) SendManyReplaceable(fromAccount string, amounts map[string]float64, minconf uint32, comment string, feefrom []string, replaceable *bool) (txID string, err error) {
...
func (b *Bgld) SendToAddress(toAddress string, amount float64, comment, commentTo string) (txID string, err error) {
...
func (b *Bgld) SetAccount(address, account string) error {
...
func (b *Bgld) VerifyMessage(address, sign, message string) (success bool, err error) {
...
func (b *Bgld) ValidateAddress(address string) (va ValidateAddressResponse, err error) {
...
// https://bitcoincore.org/en/doc/0.16.0/rpc/util/estimatesmartfee/
func (b *Bgld) EstimateSmartFee(minconf int) (ret EstimateSmartFeeResult, err error) {
...
// EstimateSmartFee stimates the approximate fee per kilobyte needed for a transaction..
// https://bitcoincore.org/en/doc/0.16.0/rpc/util/estimatesmartfee/
func (b *Bgld) EstimateSmartFeeWithMode(minconf int, mode string) (ret EstimateSmartFeeResult, err error) {
...
func (b *Bgld) GetWalletInfo() (i WalletInfo, err error) {
